# the log method is applied to the result of 2 numbers being divided. if both are ints, then
#   integer division occurred. the error was corrected by forcing one of the data points into a float
#
# reflection
#   could have used fdiv for float div
...
def tfidf(term, document, documents)
  # puts '1: ' + tf(term, document).to_s
  # puts '2: ' + idf(term, documents).to_s
  # puts
